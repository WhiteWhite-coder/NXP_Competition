...
//        AD_guiyihua();
//        AD_Cal_error();
//        speed_now_left = qtimer_quad_get(QTIMER_1,Speed_A1);       
//        qtimer_quad_clear(QTIMER_1,Speed_A1);
//        speed_now_right = -(qtimer_quad_get(QTIMER_1,Speed_A2));        
//        qtimer_quad_clear(QTIMER_1,Speed_A2);
        //速度预测
